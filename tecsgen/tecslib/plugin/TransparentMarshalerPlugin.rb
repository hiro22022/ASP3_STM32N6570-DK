...
class TransparentMarshalerPlugin < SignaturePlugin
  ...
  def initialize( signature, option )
    ...
    initialize_transparent_marshaler signature.get_name

    @plugin_arg_check_proc_tab = TransparentMarshalerPluginArgProc
    parse_plugin_arg
    # check_PPAllocator
    ...
    print "TransparentMarshalerPlugin: signature=#{signature.get_namespace_path}, PPAllocator=#{necessity}\n"
  end
